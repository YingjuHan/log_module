...
#  endif
#else
/* No curses available - forward declare for compilation */
#include <stdbool.h>
struct _win_st;
...
/* Module JSON keys */
#define CAE_EVENTS_ID        "cae_events"
#define CAE_MODULE_DIST_ID   "cae_module_dist"
#define CAE_SEVERITY_ID      "cae_severity"
#define CAE_DURATION_ID      "cae_duration"
#define CAE_SESSION_ID       "cae_session"
#define CAE_TIMELINE_ID      "cae_timeline"
...
#define OVERALL_CAE_EVENTS   "total_events"
#define OVERALL_CAE_MODULES  "total_modules"
#define OVERALL_CAE_SESSIONS "total_sessions"
